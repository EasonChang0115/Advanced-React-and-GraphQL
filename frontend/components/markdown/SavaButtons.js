...
const SavaButtons = (props) => (
  <SavaButtonStyles>
    <button className="save-article-btn" onClick={props.saveArticleFunc}>儲存草稿</button>
    <button className="release-article-btn" onClick={props.releaseArticleFunc}>發布文章</button>
  </SavaButtonStyles>
)
